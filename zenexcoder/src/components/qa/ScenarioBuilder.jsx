...
export default function ScenarioBuilder() {
  ...
  useEffect(() => {
    const disposers = [
      window.zezenexcoderr.qa.onStreamLogs((payload) => state.applyLog(payload)),
      window.zezenexcoderr.qa.onScreenshotCapture((payload) => state.applyScreenshot(payload)),
      window.zezenexcoderr.qa.onResultFinal((payload) => state.applyResult(payload))
    ];
