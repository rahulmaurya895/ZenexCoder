...
export async function captureScreen() {
  return window.zezenexcoderr.vision.captureScreen();
}

export async function openImage() {
  return window.zezenexcoderr.vision.openImageDialog();
}

export async function readImage(filePath) {
  return window.zezenexcoderr.vision.readImage(filePath);
}
