...
const STORE_NAME = 'zezenexcoderr-environments.json';
let cache = null;
...
function fallbackKey() {
  return crypto
    .createHash('sha256')
    .update(`zezenexcoderr-env:${app.getPath('userData')}:${os.userInfo().username}:${process.env.COMPUTERNAME || os.hostname()}`)
    .digest();
}
