...
const STORE_FILE = 'zezenexcoderr-cluster.json';
let identity = null;
let previousCpuSnapshot = null;

export const CLUSTER_SERVICE_TYPE = 'zezenexcoderr';
...
export function pairingProof(sessionKey) {
  return crypto.createHmac('sha256', sessionKey).update('zezenexcoderr-pair-proof-v1').digest('base64');
}
