...
const STORE_NAME = 'zezenexcoderr-cloud-secrets.json';
...
function fallbackKey() {
  return crypto
    .createHash('sha256')
    .update(`zezenexcoderr-cloud:${app.getPath('userData')}:${os.userInfo().username}:${process.env.COMPUTERNAME || os.hostname()}`)
    .digest();
}
