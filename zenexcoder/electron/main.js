...
const store = new JsonStore({ name: 'zezenexcoderr-settings' });
...
function getPreloadPath() {
  const candidates = [
    ...
    path.join(process.cwd(), 'zezenexcoderr/out/preload/preload.mjs')
  ];
...
protocol.registerSchemesAsPrivileged([
  { scheme: 'zezenexcoderr', privileges: { standard: true, secure: true } }
]);
